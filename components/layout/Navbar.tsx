    ...
    return (
        ...
        >
            ...
            <div className="hidden md:flex gap-10 text-[10px] uppercase tracking-[0.2em] font-medium text-white/70">
                {["Home", "About", "Services", "Sectors"].map((item) => (
            ...
            <button className="group relative px-6 py-2 border border-[#D4AF37]/50 rounded-full overflow-hidden transition-all duration-300 hover:border-[#D4AF37]">
